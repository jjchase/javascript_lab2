...
const logHealth = (player, health) => `${player} health: ${health}`;
console.log(logHealth("Sam", 0));
...
const logDeath = (winner, loser) => `${winner} defeated ${loser}`;
console.log(logDeath("Jack", "Sam"));
